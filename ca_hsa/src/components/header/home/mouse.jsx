...
const mouse = () => {
    const SvgComponent = (props) => (
        ...
        >
          ...
          <path d="M327.6 506.8h44.801c71.121 0 128.8-57.68 128.8-128.8V182c0-71.121-57.68-128.8-128.8-128.8H327.6c-71.121 0-128.8 57.68-128.8 128.8v196c0 71.121 57.68 128.8 128.8 128.8zM232.397 182c0-52.641 42.559-95.199 95.199-95.199h44.801c52.641 0 95.199 42.559 95.199 95.199v196c0 52.641-42.559 95.199-95.199 95.199h-44.801c-52.641 0-95.199-42.559-95.199-95.199z" />
          <path d="M350 229.6c9.52 0 16.801-7.281 16.801-16.801v-50.398c0-9.52-7.281-16.801-16.801-16.801s-16.801 7.281-16.801 16.801v50.398c0 9.52 7.281 16.801 16.801 16.801zM402.64 390.32l-6.719-8.96L350 415.52l-45.922-34.16-6.719 8.96L350 430.078z" />
          <path d="m402.64 345.52-6.719-8.96L350 370.72l-45.922-34.16-6.719 8.96L350 385.282z" />
          <path d="m398.16 304.08-6.719-8.957-41.44 30.801-41.442-30.801-6.719 8.957L350 340.482z" />
          ...
          <use x={271.07} y={644} xlinkHref="#j" />
          <use x={280.672} y={644} xlinkHref="#f" />
          <use x={300.711} y={644} xlinkHref="#f" />
          <use x={320.758} y={644} xlinkHref="#k" />
          <use x={70} y={672} xlinkHref="#l" />
          <use x={82.184} y={672} xlinkHref="#b" />
          <use x={95.992} y={672} xlinkHref="#k" />
          <use x={115.227} y={672} xlinkHref="#m" />
          <use x={154.152} y={672} xlinkHref="#e" />
          <use x={167.535} y={672} xlinkHref="#n" />
          <use x={187.469} y={672} xlinkHref="#c" />
          <use x={216.207} y={672} xlinkHref="#o" />
          <use x={239.641} y={672} xlinkHref="#k" />
          <use x={258.879} y={672} xlinkHref="#p" />
          <use x={278.813} y={672} xlinkHref="#q" />
          <use x={308.492} y={672} xlinkHref="#r" />
          <use x={329.016} y={672} xlinkHref="#b" />
          <use x={342.82} y={672} xlinkHref="#k" />
          <use x={362.059} y={672} xlinkHref="#s" />
          <use x={371.656} y={672} xlinkHref="#c" />
          <use x={390.648} y={672} xlinkHref="#t" />
